...
import { IconAlertCircle, IconArrowBackUp, IconFileText, IconLayoutDashboard, IconMenu2, IconSettings } from '@tabler/icons-react';
...
const APP_TITLE = 'Arbeitsstunden-Tracker';
...
const navigation = [
  ...
  { name: 'Job 1 Stundeneintrag', href: '/job-1-stundeneintrag', icon: IconFileText },
  { name: 'Gesamtübersicht', href: '/gesamtuebersicht', icon: IconFileText },
  { name: 'Job 2 Stundeneintrag', href: '/job-2-stundeneintrag', icon: IconFileText },
];

const externalNavigation = [
  { name: 'Job 1 Stundeneintrag', href: '/gateway/apps/69cb734c19aa4d63f7e92821?template=list_page', icon: IconFileText },
  { name: 'Gesamtübersicht', href: '/gateway/apps/69cb73547ee4df080cc34824?template=list_page', icon: IconFileText },
  { name: 'Job 2 Stundeneintrag', href: '/gateway/apps/69cb7352247126dbd46208a7?template=list_page', icon: IconFileText },
];
    ...
    <div className="min-h-screen bg-background">
      ...
      >
        ...
        <nav className="px-3 pt-4 space-y-0.5">
          <a
            href="/gateway/apps/69cb734c19aa4d63f7e92821?template=list_page"
