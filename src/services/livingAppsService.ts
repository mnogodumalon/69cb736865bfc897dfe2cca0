...
import type { Job1Stundeneintrag, Job2Stundeneintrag, Gesamtuebersicht, CreateJob1Stundeneintrag, CreateJob2Stundeneintrag, CreateGesamtuebersicht } from '@/types/app';
