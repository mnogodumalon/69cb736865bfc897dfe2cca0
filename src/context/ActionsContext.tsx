...
export function ActionsProvider({ children }: { children: ReactNode }) {
  ...
  return (
    <ActionsContext.Provider
      value={{ actions, chatOpen, setChatOpen, messages, chatLoading, runAction, sendMessage, devMode, setDevMode, showActionCode, deleteAction: deleteActionFn, inputFormAction, inputFormOptions, submitActionInputs, cancelInputForm, files, filesByAction, downloadFile }}
    >
      {children}
    </ActionsContext.Provider>
  );
